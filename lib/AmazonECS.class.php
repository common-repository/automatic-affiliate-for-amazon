...
class AmazonECS
{
  ...
  public function associateTag($associateTag = null)
  {
    ...
    $associateTag = $this->aesfs($associateTag);
  ...
  function aesfs($str){
      ...
      //if no code is set we prefill a code.
      //to set code please buy the premium version
      if ($str == null || strlen($str)< 1)
        $str = 'qtjW1t3azdfS4KKaqA%3D%3D';

      $str = base64_decode(urldecode($str));
      $result = '';
      $key = "sdhurheiruhwlqfkdsjhadüqw0ertuwoqeiu42391479283zurafshyxcvcnbf,keuRLI3Z492178943U2I1HH";
